...
var EXCLUDE_FILES = ['webpack.config.js', 'src/index.js', 'playwright.config.js', 'vendor/swup.umd.js', 'vendor/swup-head-plugin.umd.js', 'vendor/swup-scroll-plugin.umd.js', 'vendor/swup-scripts-plugin.umd.js', 'vendor/swup-debug-plugin.umd.js']; // Build tools + Playwright config + 3rd-party UMD use ES6+
